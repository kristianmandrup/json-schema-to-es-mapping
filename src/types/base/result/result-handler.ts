import { createKeyMaker } from "./key-maker";
import { createTypeHandler } from "../type-handler";
import { InfoHandler } from "../../info";

export const createResultHandler = (opts, config) =>
  new ResultHandler(opts, config);

export class ResultHandler extends InfoHandler {
  opts: any;
  resultKey: (obj?: any) => string;
  dispatcher: any; // IDispatcher
  entry: any; // IEntry
  resultMap: any; // IResultMap
  protected _result: any; // IResult
  protected _type: string;
  protected _keyMaker: any; // IKeyMaker
  protected _typeHandler: any; // ITypeHandler
